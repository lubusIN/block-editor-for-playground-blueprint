...
function BlueprintSidebarSettings() {
	const { updateBlueprintConfig, blueprint_config } = useBlueprintData();
			...
			>
				<DataForm
					data={ {
						...
						extraLibraries:
							blueprint_config.extraLibraries || false,
					} }
					fields={ [
						{
 ...
 */
registerPlugin( 'blueprint-version-control', {
